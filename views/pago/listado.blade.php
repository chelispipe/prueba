								                ...
								                <div class="x_panel">
								                  ...
								                  <div class="x_content">
								                    <p class="text-muted font-13 m-b-30">
								                      ...
								                      El siguiente listado corresponde a los empeños que ha realizado el cliente {{$clientes->nombre}} {{$clientes->apellido}}.
								                        ...
								                        <tr>
								                          ...
								                          <td>
																<div class="hidden-sm hidden-xs action-buttons">
																	<a class="green" href="{{ url('generarPago') }}/{{$empenos->id}}">
