			...
			<div class="col-xs-12">
				...
				<div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                          <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true"> <i class="green ace-icon fa fa-check bigger-120"></i> Cantidad Activos <span class="badge badge-success">{{$empleados->count()}}</span> </a>
                          </li>
                          <li role="presentation" class=""><a href="#tab_content2" role="tab" id="home-tab" data-toggle="tab" aria-expanded="true"><i class="red ace-icon fa fa-close bigger-120"></i> Cantidad Inactivos <span class="badge badge-success">{{$inactivos->count()}}</span> </a>
                          </li>
								                      ...
								                      @foreach($empleados as $empleados)
								                        <tr>
								                        	<td class="text-center">
																<img src="{{asset('production/images/empleados')}}/{{$empleados->foto}}" alt="{{$empleados->foto}}" class="img-circle" width="50px" height="50px">
															</td>
								                          <td>{{$empleados->identificacion}}</td>
								                          <td>{{$empleados->nombre}} {{$empleados->apellido}}</td>
								                          <td>{{$empleados->direccion}}</td>
								                          <td>{{$empleados->telefono}}<br>{{$empleados->celular}}</td>
								                          <td>
																<div class="hidden-sm hidden-xs action-buttons">
																	<a class="blue" href="{{url('viewEmpleado')}}/{{$empleados->id}}">
																		<i class="ace-icon fa fa-search bigger-130"></i>
																	</a>

																	<a class="green" href="{{url('editEmpleado')}}/{{$empleados->id}}">
																		<i class="ace-icon fa fa-pencil bigger-130"></i>
																	</a>

																	<a class="red" href="{{url('desactivarEmpleado')}}/{{$empleados->id}}" id="btn_eliminar" name="btn_eliminar" value="{{-- {{$empleados->id}} --}}">
																...
																<div class="hidden-md hidden-lg">
																	<div class="inline pos-rel">
																		...
																		<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																			...
																			<li>
																				<a href="{{url('viewEmpleado')}}/{{$empleados->id}}" class="tooltip-success" data-rel="tooltip" title="Detalles">
																					<span class="blue">
																			...
																			<li>
																				<a href="{{url('editEmpleado')}}/{{$empleados->id}}" class="tooltip-success" data-rel="tooltip" title="Editar">
																					<span class="green">
																			...
																			<li>
																				<a href="{{url('desactivarEmpleado')}}/{{$empleados->id}}" class="tooltip-error btn btn-default source" data-rel="tooltip" title="Eliminar" id="btn_eliminar" name="btn_eliminar" value="{{-- {{$empleados->id}} --}}">
																					<span class="red">
								                  ...
								                  <div class="x_content">
								                    ...
								                    <table id="inactiva" class="table table-striped table-bordered ">
								                      ...
								                      @foreach($inactivos as $inactivos)
								                        <tr>
								                        	<td class="text-center">
																<img src="{{asset('production/images/empleados')}}/{{$inactivos->foto}}" alt="{{$inactivos->foto}}" class="img-circle" width="50px" height="50px">
															</td>
																...
																<div class="hidden-md hidden-lg">
																	<div class="inline pos-rel">
																		...
																		<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																			...
																			<li>
																				<a href="{{url('activarEmpleado')}}/{{$inactivos->id}}" class="tooltip-error btn btn-default source" data-rel="tooltip" title="Eliminar" id="btn_eliminar" name="btn_eliminar" value="{{-- {{$inactivos->id}} --}}">
																					<span class="blue">
					...
					<div class="modal-dialog modal-lg">
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<form enctype="multipart/form-data" class="form-horizontal" id="validation-form" method="post" action="{{url('createEmpleado')}}" >
